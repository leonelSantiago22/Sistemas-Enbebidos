...
void loop() {
  miColor(255 - 255, 255- 255, 255 - 0); //se despliega el color amarillo
  delay(2000);
  
  miColor(255 - 255, 255 -118, 255 - 192); //se despliega el color rosa
  delay(2000);
  
  miColor(255 - 0, 255 - 255, 255 - 255); //Se despliega el color cian
  delay(2000);

  miColor(255 - 255, 255 - 0, 255 - 255); //Se despliega el color magenta
  delay(2000);
